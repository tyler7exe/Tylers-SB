...
⚙️| __**{lang.text('help_config')}:**__
 ...
 `{config_selfbot.prefix}lang`""", delete_after=config_selfbot.deltime)
    ...
    🏯| __**{lang.text('help_raid')}:**__
     ...
     `{config_selfbot.prefix}exe <@user> <msg1>, <msg2>`: Auto-respond to a mentioned user with random messages""", delete_after=config_selfbot.deltime)
...
📖| __**{lang.text('help_templates')}:**__
 ...
 `{config_selfbot.prefix}use `: {lang.text('template_help_self')}
