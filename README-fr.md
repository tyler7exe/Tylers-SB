[![English version](https://img.shields.io/badge/Read%20in-english-blue?style=for-the-badge&logo=appveyor)](https://github.com/Sitois/Tyler's SB/blob/main/README.md)
...
<div align="center">
  ...
  [![GitHub release (latest by date)](https://img.shields.io/github/v/release/Sitois/Tyler's SB.svg?style=flat)](https://github.com/Sitois/Tyler's SB/releases)
  [![GitHub downloads](https://img.shields.io/github/downloads/Sitois/Tyler's SB/total.svg?style=flat)](https://github.com/Sitois/Tyler's SB/releases)
  [![GitHub stars](https://img.shields.io/github/stars/Sitois/Tyler's SB.svg?style=flat)](https://github.com/Sitois/Tyler's SB/stargazers)
  [![GitHub watchers](https://img.shields.io/github/watchers/Sitois/.svg?style=flat)](https://github.com/Sitois/Tyler's SB/watchers)
  [![CodeFactor](https://www.codefactor.io/repository/github/Sitois/Tyler's SB/badge?style=flat)](https://www.codefactor.io/repository/github/Sitois/Tyler's SB)
  [![GitHub issues](https://img.shields.io/github/issues/Sitois/Tyler's SB.svg?style=flat)](https://github.com/Sitois/Tyler's SB/issues)
  ...
  [![Telegram Support](https://img.shields.io/endpoint?url=https%3A%2F%2Frunkit.io%2Fdamiankrawczyk%2Ftelegram-badge%2Fbranches%2Fmaster%3Furl%3Dhttps%3A%2F%2Ft.me%2F_support)](https://t.me/_support)
</div>
...
## 📖 Table des matières
1. [💾 Installation](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-installation)
2. [🔧 Configuration](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-configuration)
3. [🌟 Fonctionnalités](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-fonctionnalit%C3%A9s)
4. [📜 Comment obtenir son token](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-comment-obtenir-son-token)
5. [👀 Aperçu](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-aper%C3%A7u)
6. [☣️ Problèmes](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#%EF%B8%8F-probl%C3%A8mes)
7. [🛠️ Developement version](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#%EF%B8%8F-developement-version)
8. [❓ Comment contribuer](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-comment-contribuer)
9. [⭐ Contributeurs](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-contributeurs)
10. [🫂 Support](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#support)

## 💾 Installation

1. Téléchargez la dernière version depuis la section [Releases](https://github.com/Sitois/Tyler's SB/releases) sur GitHub.
2. Assurez-vous d'avoir [Python](https://www.python.org/downloads/ "Installez Python ici") installé.
3. Ouvrez votre Terminal et rendez-vous dans le dossier  en utilisant `cd`.
4. Installez les dépendances : `pip install -r requirements.txt`
5. Exécutez le programme : `python main.py`
6. Commencez avec `&help` !

## 🔧 Configuration
Ouvrez `config_selfbot.py` avec n'importe quel éditeur de texte et saisissez un [token d'__utilisateur__](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#-comment-obtenir-son-token).
...
```
Et maintenant, vous aurez seulement besoin de ré-installer discord.py-self (depuis Git ou depuis [ici](https://github.com/Sitois/Tyler's SB/releases/latest))
...
### Problèmes de 
Allez dans le [support](https://github.com/Sitois/Tyler's SB/blob/main/README-fr.md#support)!

## 🛠️ Version en cours de développement
1. Ouvrez votre Terminal et rendez-vous dans le dossier souhaitée à l'aide de `cd`.
2. Clonez le repo: `git clone https://github.com/Sitois/Tyler's SB`
**ou**
...
[![](https://visitcount.itsvg.in/api?id=&label=Repo%20Views&color=2&icon=5&pretty=false)](https://visitcount.itsvg.in)

---

-V1: [![wakatime](https://wakatime.com/badge/user/018af69f-9d50-4699-932d-026a9efb0401/project/018d13ec-4c15-459c-b9a8-e02089e7681b.svg)](https://wakatime.com/badge/user/018af69f-9d50-4699-932d-026a9efb0401/project/018d13ec-4c15-459c-b9a8-e02089e7681b)

Tyler's SB: [![wakatime](https://wakatime.com/badge/user/018af69f-9d50-4699-932d-026a9efb0401/project/018e9e0c-29ce-4e43-9113-34945236a808.svg)](https://wakatime.com/badge/user/018af69f-9d50-4699-932d-026a9efb0401/project/018e9e0c-29ce-4e43-9113-34945236a808)
